...
Definition f_number_get := {|
  ...
  fn_params := ((_n, (tptr (Tstruct _number noattr))) :: (_i, tulong) :: nil);
  fn_vars := nil;
  fn_temps := ((_t'1, tulong) :: (_t'4, tulong) :: (_t'3, (tptr tulong)) ::
               (_t'2, tulong) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _t'2
      (Efield
        (Ederef (Etempvar _n (tptr (Tstruct _number noattr)))
          (Tstruct _number noattr)) _size tulong))
    (Sifthenelse (Ebinop Olt (Etempvar _i tulong) (Etempvar _t'2 tulong)
                   tint)
      (Ssequence
        (Sset _t'3
          (Efield
        ...
        (Ssequence
          (Sset _t'4
            (Ederef
              (Ebinop Oadd (Etempvar _t'3 (tptr tulong)) (Etempvar _i tulong)
                (tptr tulong)) tulong))
          (Sset _t'1 (Ecast (Etempvar _t'4 tulong) tulong))))
      (Sset _t'1
        (Ecast (Ecast (Econst_int (Int.repr 0) tint) tulong) tulong))))
...
(Ssequence
  ...
  (Ssequence
    (Swhile
      (Ebinop One (Etempvar _i tulong) (Econst_int (Int.repr 0) tint) tint)
      (Ssequence
        (Sset _i
            ...
            (Ssequence
              (Sifthenelse (Ebinop Olt (Etempvar _left_digit tulong)
                ...
                (Sreturn (Some (Eunop Oneg (Econst_int (Int.repr 1) tint)
                                 tint)))
                Sskip)
              (Sifthenelse (Ebinop Olt (Etempvar _right_digit tulong)
                             (Etempvar _left_digit tulong) tint)
        ...
        (Ebinop Oadd
          (Ecast
            (Ebinop Olt (Etempvar _temporary tulong)
              (Etempvar _carry_in tulong) tint) tulong)
          (Ecast
            (Ebinop Olt (Etempvar _result tulong)
              (Etempvar _right_digit tulong) tint) tulong) tulong))
...
(Composite _number Struct
   (Member_plain _size tulong :: Member_plain _digits (tptr tulong) :: nil)
   noattr :: nil).
